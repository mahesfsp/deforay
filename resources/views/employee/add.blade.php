      ...
      <div class="row">
        <div class="col-md-8 offset-md-3">
          <div class="card">
            ...
            <i class="feather icon-plus mr-2"></i> {{__("Employee List")}}
        </a>
            <div class="card-body">
              <form action="{{ route('register') }}" method="POST" class="register-form">
                ...
                <table id="emptbl">
                  ...
                  <tr>
                    <td id="col0"><input type="text" name="cmpname[]" value="" /></td>
                    <td id="col1"><input type="text" name="salary[]" value="" /></td>
                    <td id="col2">
                      <input type="text" name="exp[]" value="" />
                    </td>
                    <td id="col3">
                      <input type="text" name="fromyear[]" value="" />
                    </td>
                    <td id="col4">
                      <input type="text" name="toyear[]" value="" />
                    </td>
                    <td id="col5">
